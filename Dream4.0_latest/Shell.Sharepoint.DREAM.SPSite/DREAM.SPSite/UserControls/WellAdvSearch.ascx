...
//
//Filename: WellAdvSearch.ascx
-->
<%@ Control Language="C#" AutoEventWireup="true" Codebehind="WellAdvSearch.ascx.cs"
    Inherits="Shell.SharePoint.DREAM.Site.UI.UserControls.WellAdvSearch" %>
                    ...
                    <tr>
                        ...
                        <td align="left" width="50%" class="tdAdvSrchItemNbrdr">
                            <asp:Button ID="cmdTopSearch" runat="server" Text="Search" CssClass="buttonAdvSrch"
                                OnClientClick="if(!ValidateWellboreSearch(false,'Well'))return false;" OnClick="cmdSearch_Click" />
    ...
    <table class="tableAdvSrchBorder" cellspacing="0" cellpadding="4" width="100%">
        <tr>
            <td class="tdAdvSrchSubHeader" colspan="4">
                <b>Search By File</b>[<a href="javascript:ResetFileSearchCriteria()" class="LinkTxt">Reset
                    File Search Criteria</a>]
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td valign="top" class="tdAdvSrchItem" style="width: 20%">
                <asp:Label ID="lblUniqueIdentifier" runat="server" Text="Unique Well Identifier"
                    Width="165px"></asp:Label></td>
            <td class="tdAdvSrchItem">
                <asp:TextBox ID="txtUnique_Well_Identifier" runat="server" Width="180px" CssClass="queryfieldmini"
                    Visible="true"></asp:TextBox>
                <asp:Image ID="imgUWI" runat="server" ImageAlign="AbsMiddle" ImageUrl="/_layouts/DREAM/images/icon_help.gif" />&nbsp;
            </td>
        ...
        <tr>
            <td valign="top" class="tdAdvSrchItem" style="width: 20%">
                <asp:Label ID="lblWellName" runat="server" Text="Well Name" Width="165px"></asp:Label></td>
            <td class="tdAdvSrchItem">
                <asp:TextBox ID="txtWell_Name" runat="server" Width="180px" CssClass="queryfieldmini"
                    Visible="true"></asp:TextBox>
                <asp:Image ID="imgWellName" runat="server" ImageAlign="AbsMiddle" ImageUrl="/_layouts/DREAM/images/icon_help.gif"
                    Visible="true" />
            </td>
            <td colspan="2" width="50%" class="tdAdvSrchItem">
                [Wildcard = * OR %]</td>
        ...
        <tr>
            <td valign="top" class="tdAdvSrchItem" style="width: 20%">
                <asp:Label ID="lblCommonName" runat="server" Text="Well Common Name" Width="165px"></asp:Label></td>
            <td class="tdAdvSrchItem">
                <asp:TextBox ID="txtCommon_Name" runat="server" Width="180px" CssClass="queryfieldmini"
                    Visible="true"></asp:TextBox>
        ...
        <tr>
            <td valign="top" class="tdAdvSrchItem" style="width: 20%">
                <asp:Label ID="lblAliasName" runat="server" Text="Well Alias Name" Width="165px"></asp:Label></td>
            <td class="tdAdvSrchItem">
        ...
        <tr>
            ...
            <td colspan="3" class="tdAdvSrchItem" valign="top">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr valign="top">
                        <td>
        ...
        <tr>
            ...
            <td colspan="3" class="tdAdvSrchItem">
                <asp:ListBox ID="lstCurrent_Status" EnableViewState="true" runat="server" Width="185px"
                    CssClass="dropdownAdvSrch" SelectionMode="Multiple"></asp:ListBox>&nbsp;
                <asp:Image ID="imgWellStatus" runat="server" ImageAlign="AbsMiddle" ImageUrl="/_layouts/DREAM/images/icon_help.gif"
                    Visible="true" />
            </td>
        </tr>
        <tr>
        ...
        <tr id="TR4" style="display: none;">
            ...
            <td class="tdAdvSrchItem" colspan="3" height="19px">
                <asp:TextBox ID="txtMinLatDeg" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0')"
                    CssClass="queryfieldmini"></asp:TextBox>
                deg &nbsp;
                <asp:TextBox ID="txtMinLatMin" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                min &nbsp;
                <asp:TextBox ID="txtMinLatSec" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0')"
                    CssClass="queryfieldmini"></asp:TextBox>
                sec&nbsp;
        ...
        <tr id="TR5" style="display: none;">
            <td class="tdAdvSrchItem" style="width: 20%">
                Longitude</td>
            <td class="tdAdvSrchItem" colspan="3">
                <asp:TextBox ID="txtMinLonDeg" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                deg &nbsp;
                <asp:TextBox ID="txtMinLonMin" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                min &nbsp;
                <asp:TextBox ID="txtMinLonSec" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                sec&nbsp;
        ...
        <tr id="TR7" style="display: none;">
            ...
            <td class="tdAdvSrchItem" colspan="3" height="32px">
                <asp:TextBox ID="txtMaxLatDeg" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                deg&nbsp;
                <asp:TextBox ID="txtMaxLatMin" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                min&nbsp;
                <asp:TextBox ID="txtMaxLatSec" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                sec&nbsp;&nbsp;
        ...
        <tr id="TR8" style="display: none;">
            <td class="tdAdvSrchItem" style="width: 20%">
                Longitude</td>
            <td class="tdAdvSrchItem" colspan="3">
                <asp:TextBox ID="txtMaxLonDeg" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                deg&nbsp;
                <asp:TextBox ID="txtMaxLonMin" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                min&nbsp;
                <asp:TextBox ID="txtMaxLonSec" runat="server" Width="50px" onblur="javascript:SetTextBoxValue(this,'0');"
                    CssClass="queryfieldmini"></asp:TextBox>
                sec&nbsp;
        ...
        <tr>
            ...
            <td height="25px" width="30%" class="tdAdvSrchItemNbrdr">
                <asp:TextBox ID="txtSaveSearch" runat="server" Width="180px" onkeydown="if(event.keyCode == 13){if(!ValidateWellboreSaveSearch('Well'))return false;};"
                    CssClass="queryfieldmini"></asp:TextBox>
            ...
            <td align="left" colspan="1" width="50%" class="tdAdvSrchItemNbrdr">
                ...
                <asp:Button ID="cmdSearch" runat="server" Text="Search" CssClass="buttonAdvSrch"
                    OnClick="cmdSearch_Click" OnClientClick="if(!ValidateWellboreSearch(false,'Well'))return false;" />
...
<script type="text/JavaScript">
    setWindowTitle("Advanced Search - Well");
    ...
    if(document.getElementById(GetObjectID("chbDates", "input")).checked == true)
    {
        resetDateTable();
    }
    if(document.getElementById(GetObjectID("chbGeographicalSearch", "input")).checked == true)
    {
