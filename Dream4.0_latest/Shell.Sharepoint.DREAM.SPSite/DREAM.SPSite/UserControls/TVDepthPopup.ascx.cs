...
namespace Shell.SharePoint.DREAM.Site.UI.UserControls
{
    ...
    /// </summary>
    public partial class TVDepthPopup :System.Web.UI.UserControl
    {
        ...
        protected void BtnPopulateDepth_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string DepthValues = txtTVTopDepth.Text + "|" + txtTVBottomDepth.Text + "|" + txtTVDepthInterval.Text + "|TVD";
                Session["DepthValues"] = DepthValues.ToString();
