            ...
            <table id="MSO_ContentTable" style="width:100%;height:100%;" border="0" cellspacing="0" cellpadding="0" class="123ms-propertysheet">
                <tr >
	                <td valign="top" style="width:100%;height:100%;">	              
                      <telerik:RadSplitter ID="splitterMainExternalSite" runat="server"  Width="100%" Height="1900" OnClientLoaded="OnRadSplitterLoadedExternalSite" Orientation="Vertical" VisibleDuringInit="false">
