<xsl:stylesheet version="1.0"
            ...
            <td>
              <ul class="tabNavigation">
               ...
               <li>
                 ...
                 <li>
                  <a>
                   <span id="lblMechanicalcontent" style="cursor:hand" onclick="javascript:TabClick('mechanicalcontent','lblMechanicalcontent');">Mechanical Content</span>                  </a>
                </li>
                <li>
                  <a>
                   <span id="lblFluidscements" style="cursor:hand" onclick="javascript:TabClick('fluidscements','lblFluidscements');">Wellbore &amp; Annuli</span>                  </a>
                </li>
				<li>
                  <a>
                   <span id="lblGrossperforations" style="cursor:hand" onclick="javascript:TabClick('grossperforations','lblGrossperforations');">Gross Perforations</span>                  </a>
                </li>
				<li>
                  <a>
                   <span id="lblWellhead" style="cursor:hand" onclick="javascript:TabClick('wellhead','lblWellhead');">Well Head</span>                  </a>
                </li>
  ...
  <xsl:template name="GenerateHierarchy">
    ...
    <xsl:param name="tableId"></xsl:param>
  	...
  	<b><xsl:value-of select="$childColl/@name"></xsl:value-of>    
    </b>
  	</xsl:if> 		
        ...
        <xsl:attribute name="id">
          ...
          <!--<xsl:variable name="hierarchyName" select="$childColl"-->
            ...
            <xsl:when test="(string-length(@referencecolumn)&gt;0) and ($userPreference = 'feet')">
              <xsl:choose>
            	...
            	<xsl:if test="$childCount&gt;0">
            		<tr style="display:none">
            			...
            			<td style="width:auto;padding:6px">
            				<xsl:attribute name="colspan"><xsl:value-of select="$attrCount"/></xsl:attribute>
            				<xsl:call-template name="GenerateHierarchy">
                ...
                <!--<tr>
                  <xsl:attribute name="id">
                    <xsl:value-of select="'trComponentinfo'"/>
                  </xsl:attribute>
                  <xsl:attribute name="style">
                    <xsl:value-of select="'display:none'"/>
                  </xsl:attribute>
                  <xsl:call-template name="CreateLevel2HeaderRow">
                    <xsl:with-param name="isData" select="'true'"/>
                    <xsl:with-param name="childColl" select="$childColl"/>
                    <xsl:with-param name="loc" select="'componentinfo'"></xsl:with-param>
                  </xsl:call-template>
                </tr>-->
              </xsl:if>
  			</xsl:for-each> 
